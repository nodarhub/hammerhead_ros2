...
package_name = 'toggle_recording_py'
...
setup(
    ...
    description='This example demonstrates how to stop/start the recording in realtime by using the ROS2 interface for hammerhead.',
